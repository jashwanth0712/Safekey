...
const config = {
  title: "SafeKey: Unlock the Power of Secure File Encryption",
  tagline: "Safe is cool but SafeKey is coolest",
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: "SakeKey",
        logo: {
          alt: "SafeKey: Unlock the Power of Secure File Encryption",
          src: "img/logo1.png",
        },
        items: [
          {
